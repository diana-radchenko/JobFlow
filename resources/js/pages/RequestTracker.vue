        ...
        <div class="jobflow-page-frame">
            ...
            >
                <Card
                    ...
                    :key="item.label"
                    class="border-slate-200/70 bg-white shadow-sm transition-shadow duration-200 hover:shadow-md dark:border-slate-800"
                >
            ...
            <section v-else-if="view === 'list'" class="space-y-4">
                <Card
                    ...
                    :key="application.id"
                    class="border-slate-200/70 bg-white shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-primary/25 hover:shadow-md dark:border-slate-800"
                >
                        ...
                        >
                            <div class="grid gap-3 text-[15px] sm:grid-cols-3">
                                ...
                                <div>
                                    <span
                                        ...
                                        >Timezone</span
                                    >{{
                                        interviewFor(application)!.timezone ||
                                        'UTC'
                                    }}
                                </div>
                            </div>
                            <div class="mt-4 flex flex-wrap gap-2">
                                ...
                                <Button size="sm" @click="prepare"
                                    ><Sparkles class="mr-2 h-4 w-4" />Prepare
                                    with AI</Button
                                >
                            </div>
                        </div>
