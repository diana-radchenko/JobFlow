...
<template>
    <Sidebar collapsible="icon" variant="inset" class="border-r border-white/10 bg-[#051C2E] text-slate-200 [--sidebar-accent-foreground:#FFFFFF] [--sidebar-accent:#08263D] [--sidebar-border:rgba(255,255,255,0.10)] [--sidebar-foreground:#DCE5F4] [--sidebar-primary-foreground:#FFFFFF] [--sidebar-primary:#0A2E48] [--sidebar:#051C2E]">
        <SidebarHeader class="bg-[#051C2E] text-white"><SidebarMenu><SidebarMenuItem><SidebarMenuButton size="lg" as-child class="h-auto py-2 hover:bg-transparent hover:text-inherit active:bg-transparent active:text-inherit"><Link :href="logoUrl" @click="handleNavigation"><AppLogo /></Link></SidebarMenuButton></SidebarMenuItem></SidebarMenu></SidebarHeader>
        ...
        <SidebarFooter class="bg-[#051C2E] text-slate-200">
            <SidebarMenu>
                <SidebarMenuItem><SidebarMenuButton size="lg" as-child><Link :href="supportUrl" @click="handleNavigation"><Globe /><span class="font-medium" :class="[isEmployer ? 'text-sm' : 'text-[15px]', state === 'collapsed' && 'hidden']">Support</span></Link></SidebarMenuButton></SidebarMenuItem>
