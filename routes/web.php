...
Route::middleware(['auth', 'verified', 'role:'.UserRole::Candidate->value])->group(function () {
    ...
    Route::get('development', function () { return Inertia::render('Development'); })->name('development');
    ...
    Route::post('interview-sessions/{session}/feedback', [InterviewSessionController::class, 'feedback'])->name('interview-session.feedback');
