...
Route::post('/module-entry/{module}/{action}', [ModuleEntryController::class, 'switch'])->middleware('auth')->name('module-entry.switch');

Route::middleware(['auth', 'verified', 'role:'.UserRole::Employer->value])->prefix('employer')->name('employer.')->scopeBindings()->group(function () {
